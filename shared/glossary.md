...
| **CIP-1694 の批准構造** | DReps / CC / SPOs は三権分立ではなく、**同じ 1 つのガバナンスアクションを別々の基準で共同批准する 3 つの投票機関**。CIP-1694 自身が「異なるガバナンス機関」と呼び、アクションの種類ごとに少なくとも 2 つの批准を求める。**複数の鍵をそろえて開く共同承認に近い** | 訳さない・注釈をつける |
